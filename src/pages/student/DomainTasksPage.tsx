...
export function DomainTasksPage() {
  ...
  return (
    <div className="page py-8">
      <div className="mb-6">
        <Button variant="ghost" size="sm" onClick={() => navigate("/app/domains")} className="-ml-2 mb-3">
          <ArrowLeft className="size-4" aria-hidden="true" />
          All domains
        </Button>
        <Breadcrumbs items={[{ label: "Student", to: "/app/domains" }, { label: "Domains", to: "/app/domains" }, { label: domain.name }]} />
        ...
        <div className="mt-3 flex flex-col gap-3">
          ...
          {domain.description && (
            <p className="max-w-2xl text-sm text-pretty text-muted-foreground">{domain.description}</p>
          )}
          <div className="flex flex-wrap items-center gap-4 border-t border-border pt-4">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <span className="hidden font-mono text-[0.625rem] uppercase tracking-[0.05em] text-muted-foreground sm:inline">
