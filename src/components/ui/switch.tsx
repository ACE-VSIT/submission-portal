...
/** On-state fill is the one sanctioned violet fill outside buttons (design.md §8). */
...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      "data-[state=checked]:bg-electric data-[state=unchecked]:bg-stroke",
      className,
    )}
    {...props}
    ref={ref}
  >
    <SwitchPrimitives.Thumb
      className={cn(
        "pointer-events-none block size-4 rounded-full bg-white shadow-dropdown ring-0 transition-transform duration-150",
