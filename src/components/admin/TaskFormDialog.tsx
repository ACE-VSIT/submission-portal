        ...
        <form onSubmit={handleSubmit} noValidate className="space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            <Textarea
              ...
              placeholder={"What students must do, step by step.\nUse blank lines to separate paragraphs."}
              rows={7}
            />
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            ...
            <div className="flex items-end gap-3 pb-1">
              ...
              <Label htmlFor="t-visible" className="cursor-pointer">{isVisible ? "Visible" : "Hidden"}</Label>
            </div>
            <div className="flex items-end gap-3 pb-1">
              <Switch id="t-resubmit" checked={allowsResubmission} onCheckedChange={setAllowsResubmission} />
              <Label htmlFor="t-resubmit" className="cursor-pointer">{allowsResubmission ? "Resubmission on" : "Single submit"}</Label>
            </div>
          </div>
